...
class Wargame_env(object):
    ...
    def __init__(self):
        ...
        # 初始化想定
        from scenario_editor_04.scenario_duokong import Scenario_1
    ...
    def check_win(self):
        ...
        # 双方夺控添加分数
        # 红方
        if (red_tank_1.co_x == red_tank_1.goal[0] and red_tank_1.co_y == red_tank_1.goal[1]) or (
                red_tank_2.co_x == red_tank_2.goal[0] and red_tank_2.co_y == red_tank_2.goal[1]) or (
                red_tank_3.co_x == red_tank_3.goal[0] and red_tank_3.co_y == red_tank_3.goal[1]) or (
                red_tank_4.co_x == red_tank_4.goal[0] and red_tank_4.co_y == red_tank_4.goal[1]) or (
                red_tank_5.co_x == red_tank_5.goal[0] and red_tank_5.co_y == red_tank_5.goal[1]) or (
                red_tank_6.co_x == red_tank_6.goal[0] and red_tank_6.co_y == red_tank_6.goal[1]) or (
                red_tank_7.co_x == red_tank_7.goal[0] and red_tank_7.co_y == red_tank_7.goal[1]) or (
                red_tank_8.co_x == red_tank_8.goal[0] and red_tank_8.co_y == red_tank_8.goal[1]):
            self.red_point_flag = 1
        else:
            pass

        # 蓝方
        if (blue_tank_1.co_x == blue_tank_1.goal[0] and blue_tank_1.co_y == blue_tank_1.goal[1]) or (
                blue_tank_2.co_x == blue_tank_2.goal[0] and blue_tank_2.co_y == blue_tank_2.goal[1]) or (
                blue_tank_3.co_x == blue_tank_3.goal[0] and blue_tank_3.co_y == blue_tank_3.goal[1]) or (
                blue_tank_4.co_x == blue_tank_4.goal[0] and blue_tank_4.co_y == blue_tank_4.goal[1]) or (
                blue_tank_5.co_x == blue_tank_5.goal[0] and blue_tank_5.co_y == blue_tank_5.goal[1]) or (
                blue_tank_6.co_x == blue_tank_6.goal[0] and blue_tank_6.co_y == blue_tank_6.goal[1]) or (
                blue_tank_7.co_x == blue_tank_7.goal[0] and blue_tank_7.co_y == blue_tank_7.goal[1]) or (
                blue_tank_8.co_x == blue_tank_8.goal[0] and blue_tank_8.co_y == blue_tank_8.goal[1]) or (
                blue_tank_9.co_x == blue_tank_9.goal[0] and blue_tank_9.co_y == blue_tank_9.goal[1]) or (
                blue_tank_10.co_x == blue_tank_10.goal[0] and blue_tank_10.co_y == blue_tank_10.goal[1]):
            self.blue_point_flag = 1
        else:
            pass
        ...
        if self.rounds > 50:
            # 双方夺控分+存活分计算
            self.red_all_score = self.red_point_flag * 10 + red_tank_all_num
            self.blue_all_score = self.blue_point_flag * 10 + blue_tank_all_num
            # 蓝方总分高
            if self.red_all_score <= self.blue_all_score:
                print("Game:", self.total_episodes)
                print('Blue Win, more score')
                self.blue_win_times += 1
                self.total_episodes += 1
                self.blue_pointdefense_score += self.blue_all_score
                self.red_pointdefense_score += self.red_all_score
    ...
    def save_jpg(self):
        pg.image.save(self.screen, "current_state.jpg")
        print("Current_state is successfully saved.")
