...
class Wargame_env(object):
    ...
    def __init__(self):
        ...
        # 初始化想定
        from scenario_editor_04.scenario import Scenario_1
    ...
    def check_win(self):
        ...
        # 判断获胜条件
        # 蓝方先到达夺控点，蓝方获胜，对应项目加分
        if (blue_tank_1.co_x == blue_tank_1.goal[0] and blue_tank_1.co_y == blue_tank_1.goal[1] and blue_tank_1.num>0) or (
                blue_tank_2.co_x == blue_tank_2.goal[0] and blue_tank_2.co_y == blue_tank_2.goal[1] and blue_tank_2.num>0) or (
                blue_tank_3.co_x == blue_tank_3.goal[0] and blue_tank_3.co_y == blue_tank_3.goal[1] and blue_tank_3.num>0) or (
                blue_tank_4.co_x == blue_tank_4.goal[0] and blue_tank_4.co_y == blue_tank_4.goal[1] and blue_tank_4.num>0) or (
                blue_tank_5.co_x == blue_tank_5.goal[0] and blue_tank_5.co_y == blue_tank_5.goal[1] and blue_tank_5.num>0) or (
                blue_tank_6.co_x == blue_tank_6.goal[0] and blue_tank_6.co_y == blue_tank_6.goal[1] and blue_tank_6.num>0) or (
                blue_tank_7.co_x == blue_tank_7.goal[0] and blue_tank_7.co_y == blue_tank_7.goal[1] and blue_tank_7.num>0) or (
                blue_tank_8.co_x == blue_tank_8.goal[0] and blue_tank_8.co_y == blue_tank_8.goal[1] and blue_tank_8.num>0) or (
                blue_tank_9.co_x == blue_tank_9.goal[0] and blue_tank_9.co_y == blue_tank_9.goal[1] and blue_tank_9.num>0) or (
                blue_tank_10.co_x == blue_tank_10.goal[0] and blue_tank_10.co_y == blue_tank_10.goal[1] and blue_tank_10.num>0):
            print("Game:", self.total_episodes)
            print('Blue Win, reach the goal point.')
            self.scenario.state_controlpoint = 'blue_control'
            self.blue_win_times += 1
            self.total_episodes += 1
            self.red_get_goal_score += 0
            self.blue_get_goal_score += 40
            return True

        # 红方坦克先到达夺控点，红方获胜，对应项目加分
        elif (red_tank_1.co_x == red_tank_1.goal[0] and red_tank_1.co_y == red_tank_1.goal[1] and red_tank_1.num>0 ) or (
                red_tank_2.co_x == red_tank_2.goal[0] and red_tank_2.co_y == red_tank_2.goal[1] and red_tank_2.num>0) or (
                red_tank_3.co_x == red_tank_3.goal[0] and red_tank_3.co_y == red_tank_3.goal[1] and red_tank_3.num>0 ) or (
                red_tank_4.co_x == red_tank_4.goal[0] and red_tank_4.co_y == red_tank_4.goal[1] and red_tank_4.num>0 ) or (
                red_tank_5.co_x == red_tank_5.goal[0] and red_tank_5.co_y == red_tank_5.goal[1] and red_tank_5.num>0 ) or (
                red_tank_6.co_x == red_tank_6.goal[0] and red_tank_6.co_y == red_tank_6.goal[1] and red_tank_6.num>0 ) or (
                red_tank_7.co_x == red_tank_7.goal[0] and red_tank_7.co_y == red_tank_7.goal[1] and red_tank_7.num>0 ) or (
                red_tank_8.co_x == red_tank_8.goal[0] and red_tank_8.co_y == red_tank_8.goal[1] and red_tank_8.num>0 ) or (
                red_plane_9.co_x == red_plane_9.goal[0] and red_plane_9.co_y == red_plane_9.goal[1] and red_plane_9.num > 0) or (
                red_plane_10.co_x == red_plane_10.goal[0] and red_plane_10.co_y == red_plane_10.goal[1] and red_plane_10.num > 0):
            print("Game:", self.total_episodes)
            print('Red Win, reach the goal point.')
            self.scenario.state_controlpoint = 'red_control'
            self.red_win_times += 1
            self.total_episodes += 1
            self.red_get_goal_score += 40
            self.blue_get_goal_score += 0
            return True

        # 若红方坦克全体被歼灭，蓝方获胜，对应项目加分
        elif red_tank_1.num == 0 and red_tank_2.num == 0 and red_tank_3.num == 0 and red_tank_4.num == 0 and \
                red_tank_5.num == 0 and red_tank_6.num == 0 and red_tank_7.num == 0 and red_tank_8.num == 0:
            print("Game:", self.total_episodes)
            print('Blue Win,Kill All red tanks.')
            self.blue_win_times += 1
            self.total_episodes += 1
            self.red_get_goal_score += 0
            self.blue_get_goal_score += 40
        ...
        # 若蓝方坦克全体被歼灭，红方获胜，对应项目加分
        elif blue_tank_1.num == 0 and blue_tank_2.num == 0 and blue_tank_3.num == 0 and blue_tank_4.num == 0 and blue_tank_5.num == 0 and blue_tank_6.num == 0 and blue_tank_7.num == 0 \
                and blue_tank_8.num == 0 and blue_tank_9.num == 0 and blue_tank_10.num == 0:
            print("Game:", self.total_episodes)
            print('Red Win,Kill All blue tanks')
            self.red_win_times += 1
            self.total_episodes += 1
            self.red_get_goal_score += 40
            self.blue_get_goal_score += 0
